...
# Unity Catalogs
# Check Catalog menu item and Catalog Explorer
# Check code level
#spark.sql("SHOW CATALOGS").show(truncate=False)
#spark.sql("USE CATALOG samples")
display(spark.sql("SHOW SCHEMAS IN samples"))
#spark.sql("SHOW TABLES IN my_catalog.my_schema").show(truncate=False)
...
# MAGIC    * <a href="https://onedata.ai/what-is-data-fabric/">Data Fabric concept</a>
# MAGIC
# MAGIC
# MAGIC
